...
void inferenceTPG(float* actions) {
	...
	while(1) {
		...
		case T3: {
				const enum vertices next[3] = { A14, A19, A15,  };
		...
		case T4: {
				const enum vertices next[3] = { T0, A17, T1,  };
		...
		case T5: {
				const enum vertices next[5] = { A15, A14, A17, A15, A17,  };
		...
		case T6: {
				const enum vertices next[5] = { T4, A14, A18, A17, T2,  };
		...
		case T8: {
				const enum vertices next[5] = { A20, T6, T7, T5, A19,  };
		...
		case T9: {
				const enum vertices next[4] = { A20, A18, T8, A21,  };
		...
		case T10: {
				const enum vertices next[3] = { T9, A20, A21,  };
		...
		case T11: {
				const enum vertices next[3] = { T8, A21, T0,  };
		...
		case T12: {
				const enum vertices next[3] = { T11, A14, T10,  };
		...
		case T13: {
				const enum vertices next[3] = { T11, T10, T12,  };
