...
void inferenceTPG(fixedpt* actions) {
	...
	while(1) {
		...
		case T3: {
				const enum vertices next[5] = { A24, A21, A25, A20, A21,  };
		...
		case T9: {
				const enum vertices next[5] = { T3, A25, A20, A21, T2,  };
		...
		case T10: {
				const enum vertices next[3] = { T6, T3, T2,  };
		...
		case T11: {
				const enum vertices next[2] = { T2, A25,  };
		...
		case T12: {
				const enum vertices next[7] = { A21, T3, T10, T2, T5, A25, T8,  };
		...
		case T13: {
				const enum vertices next[4] = { T10, A25, A21, T9,  };
		...
		case T14: {
				const enum vertices next[4] = { T9, T10, T2, T8,  };
		...
		case T15: {
				const enum vertices next[4] = { T2, T9, T13, T12,  };
		...
		case T16: {
				const enum vertices next[3] = { T11, T8, T12,  };
		...
		case T18: {
				const enum vertices next[2] = { T17, A24,  };
		...
		case T19: {
				const enum vertices next[3] = { T18, A26, T16,  };
