...
void inferenceTPG(float* actions) {
	...
	while(1) {
		...
		case T1: {
				const enum vertices next[4] = { A15, A16, A17, A13,  };
		...
		case T2: {
				const enum vertices next[5] = { A13, T1, A15, A16, A13,  };
		...
		case T3: {
				const enum vertices next[6] = { A13, A13, A14, A13, T1, A12,  };
		...
		case T9: {
				const enum vertices next[7] = { T2, T5, T1, A16, T8, A14, A18,  };
		...
		case T11: {
				const enum vertices next[5] = { T9, A17, A18, A14, T10,  };
