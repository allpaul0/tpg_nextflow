...
enum vertices {T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, A13, A14, A15, A16, A17, };
...
void inferenceTPG(fixedpt* actions) {
	...
	while(1) {
		...
		case T2: {
				const enum vertices next[3] = { A15, A14, T1,  };
		...
		case T6: {
				const enum vertices next[3] = { A16, T2, A14,  };
		...
		case T10: {
				const enum vertices next[3] = { T8, T6, T9,  };
		...
		case T11: {
				const enum vertices next[4] = { T4, T6, A17, A14,  };
		...
		case T12: {
				const enum vertices next[3] = { T11, A17, T10,  };
