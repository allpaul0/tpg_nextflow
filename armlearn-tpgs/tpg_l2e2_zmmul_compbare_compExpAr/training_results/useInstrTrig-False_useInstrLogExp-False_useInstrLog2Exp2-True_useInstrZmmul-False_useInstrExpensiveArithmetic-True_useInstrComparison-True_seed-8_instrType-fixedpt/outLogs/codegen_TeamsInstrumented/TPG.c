					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_T18, &&L_T19, &&L_T20, &&L_T21, &&L_T22, &&L_T23, &&L_T24, &&L_T25, &&L_T26, &&L_T27, &&L_T28, &&L_T29, &&L_T30, &&L_A3, &&L_A4, &&L_A5, &&L_A6, &&L_A7, &&L_A0, &&L_A8, &&L_A1
    };

	/* Initial dispatch — always start at T30 */
	goto *jump_table[30];	/* == &&L_T30 */
...
L_T4: {
		static const int next[3] = { 34, 33, 36 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[4] = { 33, 2, 34, 32 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[4] = { 34, 0, 4, 34 };
		fixedpt  scores[4];
...
L_T8: {
		static const int next[4] = { 0, 4, 34, 34 };
		fixedpt  scores[4];
...
L_T9: {
		static const int next[4] = { 8, 34, 0, 3 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[5] = { 8, 1, 34, 3, 33 };
		fixedpt  scores[5];
...
L_T13: {
		static const int next[3] = { 11, 2, 6 };
		fixedpt  scores[3];
...
L_T15: {
		static const int next[4] = { 10, 33, 37, 6 };
		fixedpt  scores[4];
...
L_T16: {
		static const int next[3] = { 9, 12, 31 };
		fixedpt  scores[3];
...
L_T18: {
		static const int next[3] = { 35, 11, 10 };
		fixedpt  scores[3];
...
L_T20: {
		static const int next[6] = { 17, 33, 6, 37, 11, 33 };
		fixedpt  scores[6];
...
L_T21: {
		static const int next[4] = { 33, 6, 0, 18 };
		fixedpt  scores[4];
...
L_T24: {
		static const int next[4] = { 16, 21, 6, 13 };
		fixedpt  scores[4];
...
L_T25: {
		static const int next[5] = { 23, 37, 16, 11, 24 };
		fixedpt  scores[5];
...
L_T26: {
		static const int next[8] = { 21, 13, 37, 13, 22, 11, 16, 33 };
		fixedpt  scores[8];
        ...
        scores[1] = P63(in1, in2, in3, in4);
        scores[2] = P64(in1, in2, in3, in4);
        scores[3] = P65(in1, in2, in3, in4);
        scores[4] = P66(in1, in2, in3, in4);
        scores[5] = P67(in1, in2, in3, in4);
        scores[6] = P59(in1, in2, in3, in4);
        scores[7] = P68(in1, in2, in3, in4);
...
L_T27: {
		static const int next[8] = { 21, 13, 37, 7, 11, 16, 22, 33 };
		fixedpt  scores[8];
        ...
        scores[1] = P63(in1, in2, in3, in4);
        scores[2] = P64(in1, in2, in3, in4);
        scores[3] = P69(in1, in2, in3, in4);
        scores[4] = P67(in1, in2, in3, in4);
        scores[5] = P70(in1, in2, in3, in4);
        scores[6] = P66(in1, in2, in3, in4);
        scores[7] = P71(in1, in2, in3, in4);
...
L_T28: {
		static const int next[5] = { 37, 25, 22, 11, 26 };
		fixedpt  scores[5];
...
L_T30: {
		static const int next[4] = { 29, 28, 25, 22 };
		fixedpt  scores[4];

		__asm__ volatile("T30_start:");
		CSR_READ(CSR_REG_MCYCLE, &start);

        scores[0] = P77(in1, in2, in3, in4);
        scores[1] = P78(in1, in2, in3, in4);
        scores[2] = P73(in1, in2, in3, in4);
        scores[3] = P66(in1, in2, in3, in4);

		__asm__ volatile("T30_end:");
		CSR_READ(CSR_REG_MCYCLE, &end);

		team_cycles[30] = end - start;
