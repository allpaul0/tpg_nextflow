					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_A4, &&L_A5, &&L_A6, &&L_A3, &&L_A8, &&L_A0, &&L_A1
    };
...
L_T2: {
		static const int next[3] = { 0, 16, 20 };
		fixedpt  scores[3];
...
L_T3: {
		static const int next[4] = { 21, 0, 16, 18 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[5] = { 18, 19, 21, 16, 21 };
		fixedpt  scores[5];
...
L_T7: {
		static const int next[4] = { 16, 4, 0, 3 };
		fixedpt  scores[4];
...
L_T8: {
		static const int next[3] = { 5, 16, 17 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[5] = { 5, 17, 21, 6, 16 };
		fixedpt  scores[5];
...
L_T10: {
		static const int next[5] = { 9, 2, 8, 2, 21 };
		fixedpt  scores[5];
...
L_T11: {
		static const int next[6] = { 2, 7, 4, 6, 9, 4 };
		fixedpt  scores[6];
...
L_T12: {
		static const int next[5] = { 2, 6, 8, 10, 16 };
		fixedpt  scores[5];
...
L_T14: {
		static const int next[7] = { 2, 12, 4, 11, 13, 11, 22 };
		fixedpt  scores[7];
...
L_T15: {
		static const int next[5] = { 4, 22, 14, 12, 0 };
		fixedpt  scores[5];
