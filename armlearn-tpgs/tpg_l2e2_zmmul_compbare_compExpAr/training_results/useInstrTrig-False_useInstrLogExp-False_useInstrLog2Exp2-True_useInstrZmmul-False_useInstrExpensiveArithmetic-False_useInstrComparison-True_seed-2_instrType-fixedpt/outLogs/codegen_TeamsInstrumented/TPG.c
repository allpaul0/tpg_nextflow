					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_T18, &&L_T19, &&L_A3, &&L_A4, &&L_A5, &&L_A6, &&L_A8, &&L_A0, &&L_A1
    };
...
L_T3: {
		static const int next[3] = { 23, 22, 25 };
		fixedpt  scores[3];
...
L_T4: {
		static const int next[3] = { 23, 25, 0 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[5] = { 21, 25, 23, 20, 23 };
		fixedpt  scores[5];
...
L_T6: {
		static const int next[3] = { 5, 20, 23 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[4] = { 24, 4, 24, 2 };
		fixedpt  scores[4];
...
L_T13: {
		static const int next[6] = { 11, 10, 25, 10, 26, 10 };
		fixedpt  scores[6];
...
L_T14: {
		static const int next[7] = { 11, 26, 26, 10, 7, 13, 12 };
		fixedpt  scores[7];
...
L_T17: {
		static const int next[4] = { 10, 15, 14, 16 };
		fixedpt  scores[4];
...
L_T18: {
		static const int next[4] = { 11, 17, 14, 12 };
		fixedpt  scores[4];
...
L_T19: {
		static const int next[4] = { 26, 18, 14, 12 };
		fixedpt  scores[4];
