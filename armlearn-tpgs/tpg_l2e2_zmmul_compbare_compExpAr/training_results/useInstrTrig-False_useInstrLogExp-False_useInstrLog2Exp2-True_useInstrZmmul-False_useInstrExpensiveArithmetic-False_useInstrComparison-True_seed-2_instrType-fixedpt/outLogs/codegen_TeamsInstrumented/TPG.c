					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_T18, &&L_T19, &&L_T20, &&L_T21, &&L_T22, &&L_T23, &&L_T24, &&L_A3, &&L_A4, &&L_A5, &&L_A6, &&L_A8, &&L_A0, &&L_A1
    };
...
L_T4: {
		static const int next[3] = { 28, 30, 0 };
		fixedpt  scores[3];
...
L_T6: {
		static const int next[5] = { 26, 30, 28, 25, 28 };
		fixedpt  scores[5];
...
L_T9: {
		static const int next[3] = { 6, 25, 28 };
		fixedpt  scores[3];
...
L_T12: {
		static const int next[4] = { 29, 4, 29, 5 };
		fixedpt  scores[4];
...
L_T18: {
		static const int next[6] = { 16, 15, 30, 13, 31, 13 };
		fixedpt  scores[6];
...
L_T19: {
		static const int next[7] = { 16, 31, 31, 13, 10, 18, 17 };
		fixedpt  scores[7];
...
L_T22: {
		static const int next[4] = { 15, 20, 19, 21 };
		fixedpt  scores[4];
...
L_T23: {
		static const int next[4] = { 16, 22, 19, 17 };
		fixedpt  scores[4];
...
L_T24: {
		static const int next[4] = { 31, 23, 19, 17 };
		fixedpt  scores[4];
