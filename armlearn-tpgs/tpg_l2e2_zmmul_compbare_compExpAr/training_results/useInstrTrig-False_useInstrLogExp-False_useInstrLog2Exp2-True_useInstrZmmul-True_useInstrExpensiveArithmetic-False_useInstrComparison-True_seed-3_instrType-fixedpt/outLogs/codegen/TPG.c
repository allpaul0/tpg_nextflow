					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_A8, &&L_A0, &&L_A5, &&L_A6, &&L_A4, &&L_A2, &&L_A1
    };
...
L_T1: {
		static const int next[3] = { 14, 0, 17 };
		fixedpt  scores[3];
...
L_T2: {
		static const int next[3] = { 0, 1, 14 };
		fixedpt  scores[3];
...
L_T3: {
		static const int next[5] = { 0, 1, 2, 0, 0 };
		fixedpt  scores[5];
...
L_T4: {
		static const int next[5] = { 13, 0, 1, 2, 0 };
		fixedpt  scores[5];
...
L_T6: {
		static const int next[7] = { 5, 0, 4, 1, 2, 0, 1 };
		fixedpt  scores[7];
...
L_T8: {
		static const int next[6] = { 14, 5, 1, 3, 2, 19 };
		fixedpt  scores[6];
...
L_T9: {
		static const int next[5] = { 14, 7, 2, 5, 1 };
		fixedpt  scores[5];
...
L_T10: {
		static const int next[5] = { 14, 0, 7, 5, 9 };
		fixedpt  scores[5];
...
L_T11: {
		static const int next[4] = { 8, 6, 18, 0 };
		fixedpt  scores[4];
...
L_T12: {
		static const int next[6] = { 8, 11, 8, 10, 14, 18 };
		fixedpt  scores[6];
