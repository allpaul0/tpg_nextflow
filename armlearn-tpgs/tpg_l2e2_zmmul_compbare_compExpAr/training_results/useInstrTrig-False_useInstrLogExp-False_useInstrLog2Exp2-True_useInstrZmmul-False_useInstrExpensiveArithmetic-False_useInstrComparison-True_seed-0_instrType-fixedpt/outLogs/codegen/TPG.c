					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_A5, &&L_A6, &&L_A3, &&L_A4, &&L_A7, &&L_A8, &&L_A0, &&L_A1, &&L_A2
    };
...
L_T2: {
		static const int next[3] = { 16, 17, 19 };
		fixedpt  scores[3];
...
L_T3: {
		static const int next[4] = { 17, 16, 19, 22 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[3] = { 16, 20, 22 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[3] = { 1, 0, 16 };
		fixedpt  scores[3];
...
L_T8: {
		static const int next[3] = { 3, 21, 6 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[3] = { 8, 17, 7 };
		fixedpt  scores[3];
...
L_T12: {
		static const int next[3] = { 2, 23, 10 };
		fixedpt  scores[3];
...
L_T14: {
		static const int next[4] = { 10, 12, 7, 18 };
		fixedpt  scores[4];
...
L_T15: {
		static const int next[5] = { 11, 18, 14, 13, 24 };
		fixedpt  scores[5];
