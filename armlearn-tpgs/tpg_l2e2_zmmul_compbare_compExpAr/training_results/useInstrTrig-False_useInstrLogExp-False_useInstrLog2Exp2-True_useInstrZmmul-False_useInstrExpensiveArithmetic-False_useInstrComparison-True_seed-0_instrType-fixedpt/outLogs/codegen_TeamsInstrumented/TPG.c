					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_A5, &&L_A6, &&L_A3, &&L_A4, &&L_A7, &&L_A8, &&L_A0, &&L_A1, &&L_A2
    };
...
L_T1: {
		static const int next[4] = { 14, 13, 16, 19 };
		fixedpt  scores[4];
...
L_T2: {
		static const int next[3] = { 13, 17, 19 };
		fixedpt  scores[3];
...
L_T3: {
		static const int next[3] = { 19, 14, 13 };
		fixedpt  scores[3];
...
L_T6: {
		static const int next[3] = { 1, 18, 4 };
		fixedpt  scores[3];
...
L_T7: {
		static const int next[3] = { 6, 14, 5 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[3] = { 0, 20, 7 };
		fixedpt  scores[3];
...
L_T11: {
		static const int next[4] = { 7, 9, 5, 15 };
		fixedpt  scores[4];
...
L_T12: {
		static const int next[5] = { 8, 15, 11, 10, 21 };
		fixedpt  scores[5];
