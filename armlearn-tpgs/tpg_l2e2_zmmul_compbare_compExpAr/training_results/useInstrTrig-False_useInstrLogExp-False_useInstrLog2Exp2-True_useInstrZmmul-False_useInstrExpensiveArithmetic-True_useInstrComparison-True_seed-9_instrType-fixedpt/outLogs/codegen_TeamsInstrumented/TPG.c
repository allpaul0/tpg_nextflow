					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_A5, &&L_A6, &&L_A8, &&L_A0, &&L_A3, &&L_A4
    };
...
L_T1: {
		static const int next[3] = { 17, 14, 12 };
		fixedpt  scores[3];
...
L_T2: {
		static const int next[4] = { 12, 15, 13, 1 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[4] = { 0, 2, 13, 17 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[5] = { 2, 13, 15, 14, 12 };
		fixedpt  scores[5];
...
L_T7: {
		static const int next[6] = { 2, 4, 13, 12, 12, 15 };
		fixedpt  scores[6];
...
L_T8: {
		static const int next[6] = { 4, 6, 5, 7, 2, 12 };
		fixedpt  scores[6];
...
L_T9: {
		static const int next[7] = { 6, 3, 4, 7, 15, 5, 4 };
		fixedpt  scores[7];
...
L_T10: {
		static const int next[4] = { 6, 6, 5, 9 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[10] = { 8, 13, 2, 12, 16, 2, 10, 6, 15, 6 };
		fixedpt  scores[10];
        ...
        scores[5] = P42(in1, in2, in3, in4);
        scores[6] = P43(in1, in2, in3, in4);
        scores[7] = P44(in1, in2, in3, in4);
        scores[8] = P45(in1, in2, in3, in4);
        scores[9] = P23(in1, in2, in3, in4);
