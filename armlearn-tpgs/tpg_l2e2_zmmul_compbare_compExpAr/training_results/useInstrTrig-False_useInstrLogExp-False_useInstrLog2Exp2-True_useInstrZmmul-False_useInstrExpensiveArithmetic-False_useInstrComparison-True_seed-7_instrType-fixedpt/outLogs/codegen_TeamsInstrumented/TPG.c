					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_A3, &&L_A4, &&L_A6, &&L_A5, &&L_A8, &&L_A0, &&L_A1
    };
...
L_T0: {
		static const int next[3] = { 15, 16, 12 };
		fixedpt  scores[3];
...
L_T1: {
		static const int next[3] = { 13, 0, 11 };
		fixedpt  scores[3];
...
L_T4: {
		static const int next[4] = { 14, 13, 3, 2 };
		fixedpt  scores[4];
...
L_T5: {
		static const int next[4] = { 0, 1, 12, 14 };
		fixedpt  scores[4];
...
L_T7: {
		static const int next[4] = { 12, 5, 3, 4 };
		fixedpt  scores[4];
...
L_T8: {
		static const int next[7] = { 5, 3, 5, 4, 3, 6, 4 };
		fixedpt  scores[7];
...
L_T9: {
		static const int next[4] = { 8, 17, 8, 17 };
		fixedpt  scores[4];
...
L_T10: {
		static const int next[6] = { 8, 17, 17, 7, 8, 9 };
		fixedpt  scores[6];
