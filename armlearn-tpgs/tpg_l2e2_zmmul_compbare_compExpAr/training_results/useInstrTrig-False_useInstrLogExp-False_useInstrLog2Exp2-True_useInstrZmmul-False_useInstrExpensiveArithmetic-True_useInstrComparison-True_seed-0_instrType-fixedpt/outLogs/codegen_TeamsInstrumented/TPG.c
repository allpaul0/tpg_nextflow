					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_A4, &&L_A0, &&L_A6, &&L_A7, &&L_A5, &&L_A8, &&L_A1
    };
...
L_T0: {
		static const int next[5] = { 20, 18, 21, 18, 22 };
		fixedpt  scores[5];
...
L_T1: {
		static const int next[3] = { 21, 22, 18 };
		fixedpt  scores[3];
...
L_T3: {
		static const int next[3] = { 19, 21, 22 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[5] = { 18, 21, 19, 22, 0 };
		fixedpt  scores[5];
...
L_T7: {
		static const int next[3] = { 4, 20, 5 };
		fixedpt  scores[3];
...
L_T13: {
		static const int next[4] = { 9, 24, 4, 8 };
		fixedpt  scores[4];
...
L_T15: {
		static const int next[4] = { 2, 12, 6, 10 };
		fixedpt  scores[4];
...
L_T16: {
		static const int next[3] = { 8, 14, 3 };
		fixedpt  scores[3];
...
L_T17: {
		static const int next[3] = { 16, 15, 11 };
		fixedpt  scores[3];
