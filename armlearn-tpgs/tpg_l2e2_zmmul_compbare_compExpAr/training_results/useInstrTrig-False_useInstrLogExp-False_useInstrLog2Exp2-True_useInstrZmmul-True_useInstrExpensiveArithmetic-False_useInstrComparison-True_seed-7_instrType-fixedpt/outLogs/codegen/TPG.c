					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_A5, &&L_A6, &&L_A4, &&L_A3, &&L_A1, &&L_A0
    };
...
L_T0: {
		static const int next[3] = { 17, 18, 16 };
		fixedpt  scores[3];
...
L_T1: {
		static const int next[5] = { 17, 16, 19, 16, 15 };
		fixedpt  scores[5];
...
L_T2: {
		static const int next[4] = { 16, 18, 0, 20 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[4] = { 2, 19, 2, 3 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[4] = { 3, 2, 5, 19 };
		fixedpt  scores[4];
...
L_T7: {
		static const int next[4] = { 1, 1, 4, 6 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[4] = { 9, 1, 2, 7 };
		fixedpt  scores[4];
...
L_T12: {
		static const int next[4] = { 7, 1, 11, 10 };
		fixedpt  scores[4];
...
L_T13: {
		static const int next[3] = { 12, 1, 9 };
		fixedpt  scores[3];
...
L_T14: {
		static const int next[6] = { 2, 13, 2, 7, 7, 1 };
		fixedpt  scores[6];
