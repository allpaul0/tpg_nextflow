					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_A6, &&L_A5, &&L_A0, &&L_A3, &&L_A4, &&L_A2
    };
...
L_T0: {
		static const int next[4] = { 13, 14, 10, 11 };
		fixedpt  scores[4];
...
L_T2: {
		static const int next[6] = { 11, 11, 0, 12, 10, 15 };
		fixedpt  scores[6];
...
L_T3: {
		static const int next[4] = { 10, 2, 15, 11 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[5] = { 15, 12, 2, 11, 12 };
		fixedpt  scores[5];
...
L_T5: {
		static const int next[3] = { 14, 3, 2 };
		fixedpt  scores[3];
...
L_T6: {
		static const int next[7] = { 3, 2, 12, 1, 12, 15, 4 };
		fixedpt  scores[7];
        ...
        scores[6] = P26(in1, in2, in3, in4);

		goto *jump_table[next[bestProgram(scores, 7)]];
	}

L_T7: {
		static const int next[3] = { 6, 11, 5 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[11] = { 2, 5, 1, 11, 4, 15, 14, 12, 12, 6, 8 };
		fixedpt  scores[11];
        ...
        scores[7] = P37(in1, in2, in3, in4);
        scores[8] = P38(in1, in2, in3, in4);
        scores[9] = P39(in1, in2, in3, in4);
        scores[10] = P40(in1, in2, in3, in4);
