					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_A4, &&L_A5, &&L_A7, &&L_A8, &&L_A6, &&L_A0
    };
...
L_T0: {
		static const int next[4] = { 15, 16, 15, 18 };
		fixedpt  scores[4];
...
L_T1: {
		static const int next[6] = { 0, 15, 14, 16, 16, 17 };
		fixedpt  scores[6];
...
L_T2: {
		static const int next[7] = { 15, 1, 17, 16, 18, 18, 14 };
		fixedpt  scores[7];
...
L_T3: {
		static const int next[4] = { 18, 18, 15, 18 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[9] = { 15, 17, 18, 1, 15, 14, 19, 17, 3 };
		fixedpt  scores[9];
        ...
        scores[7] = P26(in1, in2, in3, in4);
        scores[8] = P27(in1, in2, in3, in4);
...
L_T5: {
		static const int next[6] = { 15, 17, 18, 1, 18, 14 };
		fixedpt  scores[6];
...
L_T7: {
		static const int next[6] = { 18, 18, 15, 2, 5, 16 };
		fixedpt  scores[6];
...
L_T8: {
		static const int next[3] = { 16, 6, 7 };
		fixedpt  scores[3];
...
L_T12: {
		static const int next[6] = { 8, 19, 11, 16, 9, 8 };
		fixedpt  scores[6];
...
L_T13: {
		static const int next[6] = { 12, 2, 10, 16, 8, 8 };
		fixedpt  scores[6];
