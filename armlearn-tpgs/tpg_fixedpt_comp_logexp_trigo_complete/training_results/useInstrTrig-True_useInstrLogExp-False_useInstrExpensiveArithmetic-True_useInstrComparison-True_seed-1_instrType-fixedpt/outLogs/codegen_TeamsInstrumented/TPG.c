					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_A5, &&L_A6, &&L_A4, &&L_A0, &&L_A3, &&L_A1
    };
...
L_T1: {
		static const int next[3] = { 15, 12, 17 };
		fixedpt  scores[3];
...
L_T2: {
		static const int next[5] = { 14, 13, 12, 17, 15 };
		fixedpt  scores[5];
...
L_T3: {
		static const int next[6] = { 14, 15, 13, 13, 12, 2 };
		fixedpt  scores[6];
...
L_T4: {
		static const int next[4] = { 13, 15, 17, 12 };
		fixedpt  scores[4];
...
L_T7: {
		static const int next[5] = { 0, 13, 3, 5, 17 };
		fixedpt  scores[5];
...
L_T8: {
		static const int next[4] = { 0, 3, 5, 4 };
		fixedpt  scores[4];
...
L_T9: {
		static const int next[4] = { 8, 7, 5, 5 };
		fixedpt  scores[4];
...
L_T10: {
		static const int next[4] = { 8, 7, 16, 9 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[4] = { 10, 16, 6, 16 };
		fixedpt  scores[4];
