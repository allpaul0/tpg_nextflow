					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_A6, &&L_A5, &&L_A0, &&L_A8, &&L_A7, &&L_A2, &&L_A4
    };
...
L_T0: {
		static const int next[4] = { 16, 13, 14, 15 };
		fixedpt  scores[4];
...
L_T1: {
		static const int next[4] = { 15, 14, 15, 13 };
		fixedpt  scores[4];
...
L_T2: {
		static const int next[4] = { 14, 14, 15, 17 };
		fixedpt  scores[4];
...
L_T3: {
		static const int next[6] = { 14, 14, 15, 13, 15, 1 };
		fixedpt  scores[6];
...
L_T4: {
		static const int next[5] = { 0, 2, 14, 16, 13 };
		fixedpt  scores[5];
...
L_T6: {
		static const int next[5] = { 15, 0, 14, 16, 13 };
		fixedpt  scores[5];
...
L_T7: {
		static const int next[6] = { 15, 14, 16, 5, 13, 13 };
		fixedpt  scores[6];
...
L_T10: {
		static const int next[5] = { 19, 3, 17, 17, 7 };
		fixedpt  scores[5];
...
L_T11: {
		static const int next[3] = { 8, 13, 9 };
		fixedpt  scores[3];
...
L_T12: {
		static const int next[5] = { 19, 13, 10, 17, 11 };
		fixedpt  scores[5];
