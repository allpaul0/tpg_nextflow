					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_A5, &&L_A6, &&L_A2, &&L_A3, &&L_A7, &&L_A8, &&L_A0, &&L_A4, &&L_A1
    };
...
L_T4: {
		static const int next[3] = { 0, 0, 22 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[3] = { 22, 22, 0 };
		fixedpt  scores[3];
...
L_T6: {
		static const int next[4] = { 0, 3, 21, 15 };
		fixedpt  scores[4];
...
L_T7: {
		static const int next[4] = { 21, 5, 0, 22 };
		fixedpt  scores[4];
...
L_T8: {
		static const int next[4] = { 21, 22, 22, 4 };
		fixedpt  scores[4];
...
L_T9: {
		static const int next[6] = { 7, 6, 8, 4, 7, 2 };
		fixedpt  scores[6];
...
L_T10: {
		static const int next[4] = { 7, 8, 7, 2 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[6] = { 21, 6, 8, 20, 7, 7 };
		fixedpt  scores[6];
...
L_T12: {
		static const int next[5] = { 8, 8, 10, 18, 11 };
		fixedpt  scores[5];
...
L_T13: {
		static const int next[4] = { 12, 11, 9, 12 };
		fixedpt  scores[4];
...
L_T14: {
		static const int next[6] = { 20, 23, 0, 18, 13, 12 };
		fixedpt  scores[6];
