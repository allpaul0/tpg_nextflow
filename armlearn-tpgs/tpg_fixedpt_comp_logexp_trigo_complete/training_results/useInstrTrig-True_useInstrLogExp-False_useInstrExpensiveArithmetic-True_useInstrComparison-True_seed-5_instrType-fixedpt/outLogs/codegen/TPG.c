					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_A3, &&L_A4, &&L_A5, &&L_A6, &&L_A7, &&L_A8, &&L_A0, &&L_A2, &&L_A1
    };
...
L_T0: {
		static const int next[4] = { 18, 19, 20, 21 };
		fixedpt  scores[4];
...
L_T3: {
		static const int next[4] = { 19, 22, 1, 0 };
		fixedpt  scores[4];
...
L_T5: {
		static const int next[6] = { 21, 3, 19, 23, 21, 20 };
		fixedpt  scores[6];
...
L_T6: {
		static const int next[5] = { 20, 23, 22, 2, 19 };
		fixedpt  scores[5];
...
L_T8: {
		static const int next[6] = { 23, 5, 26, 24, 19, 19 };
		fixedpt  scores[6];
...
L_T9: {
		static const int next[5] = { 8, 6, 4, 19, 4 };
		fixedpt  scores[5];
...
L_T10: {
		static const int next[7] = { 3, 20, 8, 26, 19, 5, 0 };
		fixedpt  scores[7];
        ...
        scores[6] = P37(in1, in2, in3, in4);

		goto *jump_table[next[bestProgram(scores, 7)]];
	}

L_T11: {
		static const int next[7] = { 3, 23, 19, 5, 0, 8, 26 };
		fixedpt  scores[7];
...
L_T12: {
		static const int next[10] = { 8, 9, 20, 26, 19, 25, 26, 8, 20, 0 };
		fixedpt  scores[10];
        ...
        scores[8] = P49(in1, in2, in3, in4);
        scores[9] = P50(in1, in2, in3, in4);

		goto *jump_table[next[bestProgram(scores, 10)]];
	}

L_T13: {
		static const int next[4] = { 12, 8, 11, 12 };
		fixedpt  scores[4];
...
L_T14: {
		static const int next[3] = { 8, 10, 8 };
		fixedpt  scores[3];
...
L_T15: {
		static const int next[5] = { 12, 8, 12, 11, 10 };
		fixedpt  scores[5];
...
L_T17: {
		static const int next[6] = { 8, 13, 7, 16, 15, 11 };
		fixedpt  scores[6];
