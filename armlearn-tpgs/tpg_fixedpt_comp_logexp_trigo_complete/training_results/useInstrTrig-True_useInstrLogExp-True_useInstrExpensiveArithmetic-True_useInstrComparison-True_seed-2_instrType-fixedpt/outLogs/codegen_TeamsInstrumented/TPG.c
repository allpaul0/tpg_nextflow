					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_A6, &&L_A4, &&L_A5, &&L_A8, &&L_A0, &&L_A2
    };
...
L_T2: {
		static const int next[4] = { 15, 13, 17, 0 };
		fixedpt  scores[4];
...
L_T3: {
		static const int next[4] = { 0, 17, 16, 15 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[4] = { 5, 0, 0, 13 };
		fixedpt  scores[4];
...
L_T7: {
		static const int next[6] = { 3, 13, 18, 17, 0, 17 };
		fixedpt  scores[6];
...
L_T8: {
		static const int next[5] = { 13, 15, 2, 6, 17 };
		fixedpt  scores[5];
...
L_T9: {
		static const int next[10] = { 3, 15, 2, 6, 18, 17, 18, 13, 8, 16 };
		fixedpt  scores[10];
        ...
        scores[8] = P31(in1, in2, in3, in4);
        scores[9] = P10(in1, in2, in3, in4);
...
L_T11: {
		static const int next[3] = { 9, 10, 7 };
		fixedpt  scores[3];
...
L_T12: {
		static const int next[6] = { 9, 10, 11, 9, 14, 9 };
		fixedpt  scores[6];
