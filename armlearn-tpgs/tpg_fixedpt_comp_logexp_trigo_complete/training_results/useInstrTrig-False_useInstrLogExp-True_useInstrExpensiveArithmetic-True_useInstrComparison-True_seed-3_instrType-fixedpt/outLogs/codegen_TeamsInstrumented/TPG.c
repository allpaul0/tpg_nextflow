					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_T18, &&L_T19, &&L_T20, &&L_A6, &&L_A7, &&L_A5, &&L_A4, &&L_A0, &&L_A3, &&L_A2
    };
...
L_T0: {
		static const int next[4] = { 21, 25, 24, 26 };
		fixedpt  scores[4];
...
L_T1: {
		static const int next[3] = { 25, 22, 24 };
		fixedpt  scores[3];
...
L_T4: {
		static const int next[4] = { 23, 22, 26, 1 };
		fixedpt  scores[4];
...
L_T5: {
		static const int next[4] = { 26, 1, 22, 23 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[3] = { 23, 1, 26 };
		fixedpt  scores[3];
...
L_T7: {
		static const int next[4] = { 3, 22, 1, 6 };
		fixedpt  scores[4];
...
L_T10: {
		static const int next[4] = { 23, 2, 4, 1 };
		fixedpt  scores[4];
...
L_T13: {
		static const int next[3] = { 25, 8, 7 };
		fixedpt  scores[3];
...
L_T14: {
		static const int next[3] = { 5, 13, 8 };
		fixedpt  scores[3];
...
L_T16: {
		static const int next[6] = { 7, 9, 15, 13, 21, 4 };
		fixedpt  scores[6];
...
L_T17: {
		static const int next[6] = { 10, 11, 13, 16, 12, 11 };
		fixedpt  scores[6];
...
L_T18: {
		static const int next[5] = { 7, 13, 14, 11, 10 };
		fixedpt  scores[5];
...
L_T19: {
		static const int next[3] = { 18, 25, 5 };
		fixedpt  scores[3];
...
L_T20: {
		static const int next[8] = { 17, 14, 14, 13, 18, 25, 13, 19 };
		fixedpt  scores[8];
