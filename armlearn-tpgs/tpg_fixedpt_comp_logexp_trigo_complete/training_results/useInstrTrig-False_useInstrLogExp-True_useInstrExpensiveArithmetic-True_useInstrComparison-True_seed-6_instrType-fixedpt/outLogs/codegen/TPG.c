					...
					const fixedpt * __restrict__ in4)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_T14, &&L_T15, &&L_T16, &&L_T17, &&L_T18, &&L_A3, &&L_A4, &&L_A5, &&L_A6, &&L_A0
    };
...
L_T3: {
		static const int next[4] = { 20, 19, 23, 22 };
		fixedpt  scores[4];
...
L_T4: {
		static const int next[3] = { 23, 20, 23 };
		fixedpt  scores[3];
...
L_T5: {
		static const int next[6] = { 3, 22, 20, 4, 23, 21 };
		fixedpt  scores[6];

        scores[0] = P10(in1, in2, in3, in4);
        scores[1] = P11(in1, in2, in3, in4);
        scores[2] = P0(in1, in2, in3, in4);
...
L_T6: {
		static const int next[3] = { 3, 3, 20 };
		fixedpt  scores[3];
...
L_T7: {
		static const int next[3] = { 19, 3, 5 };
		fixedpt  scores[3];
...
L_T9: {
		static const int next[4] = { 19, 0, 6, 22 };
		fixedpt  scores[4];
...
L_T11: {
		static const int next[4] = { 10, 7, 9, 23 };
		fixedpt  scores[4];
...
L_T12: {
		static const int next[4] = { 10, 7, 7, 4 };
		fixedpt  scores[4];
...
L_T13: {
		static const int next[5] = { 7, 11, 4, 22, 2 };
		fixedpt  scores[5];
...
L_T14: {
		static const int next[6] = { 21, 4, 13, 12, 1, 10 };
		fixedpt  scores[6];
...
L_T15: {
		static const int next[3] = { 13, 12, 4 };
		fixedpt  scores[3];
...
L_T16: {
		static const int next[7] = { 4, 12, 4, 11, 13, 21, 23 };
		fixedpt  scores[7];
        ...
        scores[4] = P44(in1, in2, in3, in4);
        scores[5] = P49(in1, in2, in3, in4);
        scores[6] = P50(in1, in2, in3, in4);

		goto *jump_table[next[bestProgram(scores, 7)]];
	}

L_T17: {
		static const int next[5] = { 21, 14, 16, 11, 15 };
		fixedpt  scores[5];
...
L_T18: {
		static const int next[4] = { 12, 17, 21, 10 };
		fixedpt  scores[4];
