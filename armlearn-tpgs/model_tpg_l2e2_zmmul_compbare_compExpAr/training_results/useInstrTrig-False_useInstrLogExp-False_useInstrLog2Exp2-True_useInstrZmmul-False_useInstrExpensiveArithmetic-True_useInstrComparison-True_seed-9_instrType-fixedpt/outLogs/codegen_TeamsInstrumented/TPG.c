					...
					uint32_t * team_cycles)
{
	...
	static const void * const jump_table[] = {
		&&L_T0, &&L_T1, &&L_T2, &&L_T3, &&L_T4, &&L_T5, &&L_T6, &&L_T7, &&L_T8, &&L_T9, &&L_T10, &&L_T11, &&L_T12, &&L_T13, &&L_A5, &&L_A6, &&L_A8, &&L_A0, &&L_A3, &&L_A4
    };
...
L_T2: {
		static const int next[3] = { 19, 16, 14 };
		fixedpt  scores[3];
...
L_T4: {
		static const int next[4] = { 14, 0, 15, 2 };
		fixedpt  scores[4];
...
L_T6: {
		static const int next[4] = { 1, 4, 15, 19 };
		fixedpt  scores[4];
...
L_T8: {
		static const int next[5] = { 4, 15, 17, 3, 14 };
		fixedpt  scores[5];
...
L_T9: {
		static const int next[6] = { 4, 6, 15, 14, 14, 17 };
		fixedpt  scores[6];
...
L_T10: {
		static const int next[6] = { 6, 8, 7, 9, 4, 14 };
		fixedpt  scores[6];
...
L_T11: {
		static const int next[7] = { 8, 5, 6, 9, 17, 7, 6 };
		fixedpt  scores[7];
...
L_T13: {
		static const int next[10] = { 10, 15, 4, 14, 18, 4, 12, 8, 17, 8 };
		fixedpt  scores[10];
        ...
        scores[6] = P45(in1, in2, in3, in4);
        scores[7] = P46(in1, in2, in3, in4);
        scores[8] = P47(in1, in2, in3, in4);
        scores[9] = P25(in1, in2, in3, in4);
